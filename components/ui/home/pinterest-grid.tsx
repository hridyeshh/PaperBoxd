...
export function PinterestGrid({ books, onLoadMore, hasMore = false, isLoading = false }: PinterestGridProps) {
  ...
  // Distribute books into explicit columns (round-robin).
  // This prevents CSS column rebalancing from moving existing cards — new books
  // always append to the bottom of their assigned column.
  ...
  // Fire impression events once per books batch (fire-and-forget, idle).
  React.useEffect(() => {
