...
export function BookShareCard({
  ...
  // Aura variant - Spotify style with vertical layout for Stories
  if (variant === "aura") {
    return (
      <div
        className="relative w-[1080px] h-[1920px] bg-gradient-to-b from-zinc-900 via-zinc-950 to-black overflow-hidden flex flex-col items-center justify-center p-20"
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center w-full max-w-4xl gap-12">
          {/* Main Book Cover */}
          <div className="flex-shrink-0">
            {coverUrl && !imageError ? (
              <div className="relative aspect-[2/3] w-[600px] overflow-hidden rounded-3xl shadow-2xl bg-muted ring-1 ring-white/10">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={coverUrl}
                  alt={title}
              ...
              <div className="relative aspect-[2/3] w-[600px] bg-muted flex items-center justify-center rounded-3xl shadow-2xl ring-1 ring-white/10">
                <span className="text-muted-foreground text-3xl">No cover</span>
              </div>
            )}
          </div>
          ...
          <div className="space-y-6">
            {/* Book Title */}
            <h1 className="text-6xl font-bold tracking-tight text-white leading-tight px-4 line-clamp-3">
              {title}
            </h1>
            ...
            {rating !== undefined && (
              <div className="pt-2">
                <div className="flex items-center justify-center gap-2">
                  ...
                  <div className="text-3xl text-zinc-400 font-light">/ 5</div>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="mt-8">
            <p className="text-3xl text-zinc-400 font-light">
              on <span className="font-bold italic text-white">paperboxd.in</span>
            </p>
          </div>
        </div>
      </div>
