...
export const PBW_CASES: CaseStudy[] = [
  ...
  },
  {
    ...
    approach:
      "Planned, not shipped: a DNF status beside Reading and Finished, taking one line of reason and staying off your books-read count. Nothing marks a book abandoned yet, and there is no reason field — the profile's TBR tab lists what you have saved or started, not what you decided to put down.",
    precedent:
...
export const PBW_QS = [
  ...
  { c: "track", q: "What are the shelves?", a: "<strong>Procrastination wall</strong> (bought it, haven't opened it), <strong>Reading</strong> — anything on the wall you've logged a page against — <strong>Finished</strong>, and <strong>Liked</strong>. Your profile also has a <strong>TBR</strong> tab: what you have saved or started and not finished. There is no DNF status yet — that, with the one line of why, is the next thing being built, because giving up on a book is a reading decision and deserves a shelf of its own." },
