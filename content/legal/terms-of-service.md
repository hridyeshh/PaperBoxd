# PaperBoxd Terms of Service

**Effective date:** [PLACEHOLDER — set on publish]
**Version:** 1.0 (draft — not yet published)

> **Note:** This draft is generated from a code-level audit of the PaperBoxd codebase. It is not a substitute for legal review — in particular, §12 (Governing Law & Dispute Resolution) contains a decision that has not yet been made and needs one before this can be published.
